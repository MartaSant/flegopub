...
// 
// ISTRUZIONI:
// 1. Modifica GA_MEASUREMENT_ID con il tuo ID GA4 (riga 6)
// 2. (Opzionale) Modifica CONSENT_KEY se necessario (riga 7)
...
const GA_MEASUREMENT_ID = 'G-3XB3NBDYGM'; // ⬅️ SOSTITUISCI CON IL TUO ID GA4 (formato: G-XXXXXXXXXX)
